...
freqs = (hslider("Carrier Freq[style:knob]", 88, 0, 400, 0.0001), hslider("Message Freq 1 [style:knob]", 34, 0, 1000, 0.001), hslider("Message Freq 2 [style:knob]", 34, 0, 333, 0.001));
indices = (20, 300, -20);
...
process = hgroup("Synth", sy.fm(freqs, indices) * gate) <:  _, +(fdelay1) :>  tf22a(0.3, 0.44, 0.6, -0.44, 0.3) : si.smoo;