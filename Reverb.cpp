...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst14 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst13) / mydsp_faustpower2_f(fConst11) + -1.0f));
		...
		iConst23 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst7 - fConst22)));
		iConst24 = int(std::min<float>(2.7e+03f, std::max<float>(0.0f, 0.06f * fConst0)));
		...
		float fConst32 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst31) / mydsp_faustpower2_f(fConst30) + -1.0f));
		...
		iConst38 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst26 - fConst37)));
		...
		float fConst46 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst45) / mydsp_faustpower2_f(fConst44) + -1.0f));
		...
		iConst52 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst40 - fConst51)));
		...
		float fConst60 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst59) / mydsp_faustpower2_f(fConst58) + -1.0f));
		...
		iConst66 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst54 - fConst65)));
		...
		float fConst74 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst73) / mydsp_faustpower2_f(fConst72) + -1.0f));
		...
		iConst80 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst68 - fConst79)));
		...
		float fConst88 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst87) / mydsp_faustpower2_f(fConst86) + -1.0f));
		...
		iConst94 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst82 - fConst93)));
		...
		float fConst102 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst101) / mydsp_faustpower2_f(fConst100) + -1.0f));
		...
		iConst108 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst96 - fConst107)));
		...
		float fConst116 = std::sqrt(std::max<float>(0.0f, mydsp_faustpower2_f(fConst115) / mydsp_faustpower2_f(fConst114) + -1.0f));
		...
		iConst122 = int(std::min<float>(1024.0f, std::max<float>(0.0f, fConst110 - fConst121)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("dryWet", &fVslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec0[IOTA0 & 2047] = 0.35355338f * fRec12[0] + 1e-20f;
			float fTemp1 = float(input0[i0]);
			fVec1[IOTA0 & 4095] = fTemp1;
			float fTemp2 = 0.3f * fVec1[(IOTA0 - iConst24) & 4095];
			float fTemp3 = fTemp2 + fVec0[(IOTA0 - iConst23) & 2047] - 0.6f * fRec10[1];
			...
			fVec3[IOTA0 & 2047] = 0.35355338f * fRec16[0] + 1e-20f;
			float fTemp4 = fVec3[(IOTA0 - iConst38) & 2047] + fTemp2 - 0.6f * fRec14[1];
			...
			fVec5[IOTA0 & 2047] = 0.35355338f * fRec20[0] + 1e-20f;
			float fTemp6 = fVec5[(IOTA0 - iConst52) & 2047] - (fTemp2 + 0.6f * fRec18[1]);
			...
			fVec7[IOTA0 & 2047] = 0.35355338f * fRec24[0] + 1e-20f;
			float fTemp7 = fVec7[(IOTA0 - iConst66) & 2047] - (fTemp2 + 0.6f * fRec22[1]);
			...
			fVec9[IOTA0 & 2047] = 0.35355338f * fRec28[0] + 1e-20f;
			float fTemp9 = float(input1[i0]);
			fVec10[IOTA0 & 4095] = fTemp9;
			float fTemp10 = 0.3f * fVec10[(IOTA0 - iConst24) & 4095];
			float fTemp11 = fTemp10 + 0.6f * fRec26[1] + fVec9[(IOTA0 - iConst80) & 2047];
			...
			fVec12[IOTA0 & 2047] = 0.35355338f * fRec32[0] + 1e-20f;
			float fTemp12 = fVec12[(IOTA0 - iConst94) & 2047] + fTemp10 + 0.6f * fRec30[1];
			...
			fVec14[IOTA0 & 2047] = 0.35355338f * fRec36[0] + 1e-20f;
			float fTemp13 = 0.6f * fRec34[1] + fVec14[(IOTA0 - iConst108) & 2047];
			...
			fVec16[IOTA0 & 2047] = 0.35355338f * fRec40[0] + 1e-20f;
			float fTemp14 = 0.6f * fRec38[1] + fVec16[(IOTA0 - iConst122) & 2047];
