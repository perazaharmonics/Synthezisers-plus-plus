/* ------------------------------------------------------------
name: "untitled", "httpsfaustservicecloudgramefr"
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow11 = float(fButton3);
		float fSlow12 = float(fButton4);
		float fSlow13 = float(fButton5);
		float fSlow14 = float(fButton6);
		float fSlow15 = float(fHslider2);
		float fSlow16 = float(fHslider3);
		float fSlow17 = 1.0f - fSlow3;
		float fSlow18 = 1.0f / (fSlow3 + 1.0f);
		float fSlow19 = 1.0f / (fSlow1 * fSlow5);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fVec0[0] = fSlow8;
			float fTemp0 = fSlow8 - fVec0[1];
			float fTemp1 = fTemp0 * float(fTemp0 > 0.0f);
			fVec1[0] = fSlow9;
			float fTemp2 = fSlow9 - fVec1[1];
			float fTemp3 = fTemp2 * float(fTemp2 > 0.0f);
			fVec2[0] = fSlow10;
			float fTemp4 = fSlow10 - fVec2[1];
			float fTemp5 = fTemp4 * float(fTemp4 > 0.0f);
			fVec3[0] = fSlow11;
			float fTemp6 = fSlow11 - fVec3[1];
			float fTemp7 = fTemp6 * float(fTemp6 > 0.0f);
			fVec4[0] = fSlow12;
			float fTemp8 = fSlow12 - fVec4[1];
			float fTemp9 = fTemp8 * float(fTemp8 > 0.0f);
			fVec5[0] = fSlow13;
			float fTemp10 = fSlow13 - fVec5[1];
			float fTemp11 = fTemp10 * float(fTemp10 > 0.0f);
			fVec6[0] = fSlow14;
			float fTemp12 = fSlow14 - fVec6[1];
